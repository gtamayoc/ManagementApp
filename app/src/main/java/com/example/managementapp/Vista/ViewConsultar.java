...
import com.example.managementapp.Interfaces.InterfacesConsultar;
...
public class ViewConsultar extends AppCompatActivity implements InterfacesConsultar.ConsView {

    TextView Registrar, Consultar, Actualizar, Borrar, Inicio, Name;
    PresenterConsultar Presenter;
    Context context;
    ...
    public void vistaBoton(int opcion) {
        switch (opcion) {
            case 0:
                finish();
                Intent siguiente = new Intent(ViewConsultar.this, ViewRegistrar.class);
